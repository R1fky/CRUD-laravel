 <div class="modal fade" id="dataKaryawan" tabindex="-1" aria-labelledby="dataKaryawan" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="/datakaryawan/add" method="POST">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="dataKaryawan">Tambah Data Karyawan</h1>
